            ...
            <nav className="main-header navbar navbar-expand bg-white navbar-light border-bottom">
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <a className="nav-link" data-widget="" href="#"><i className="fa fa-bars"></i></a>
                    </li>
                                ...
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        <h3 className="dropdown-item-title">
                                            حسام موسوی
                                            <span className="float-left text-sm text-danger"><i
                                                className="fa fa-star"></i></span>
                                        </h3>
                                        <p className="text-sm">با من تماس بگیر لطفا...</p>
                                        <p className="text-sm text-muted"><i className="fa fa-clock-o mr-1"></i> 4
                                            ساعت قبل</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#" className="dropdown-item">
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        <h3 className="dropdown-item-title">
                                            سارا وکیلی
                                            <span className="float-left text-sm text-warning"><i
                                                className="fa fa-star"></i></span>
                                        </h3>
